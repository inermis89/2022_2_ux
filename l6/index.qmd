...
- 자기실현을 위해 애쓴느 것은 다른 적응적 메커니즘의 비적응적 결과물이라고 할 수 있음.
...
- 생애상 이론이 담당하는 미시적 마음구조가 모여 인구학에서 다루는 거시적 인구 현상이 나타남
...
- 사례 서비스들이 자극하는 근본동기가 무엇인지 알아보고 키 feature에 대해 알아보자.
...
- 가게 내부 뷰 및 분위기 미리 확인하는 서비스
- 온라인 판매자 상품소싱을 도와주는 플랫폼
- 인디게임
- 올바른 PT시장을 만드는 플랫폼
- NFT를 활용한 참여형 인디음악 팬덤 플랫폼
- 관심사 기반 SNS
- 아이돌 포토카드 교환
